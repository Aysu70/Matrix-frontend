...
import Portfolio_1 from '../assets/photos/portfolio-img1.png'
import Portfolio_2 from '../assets/photos/portfolio-img2.png'
import Portfolio_3 from '../assets/photos/portfolio-img3.png'
import Portfolio_4 from '../assets/photos/portfolio-img4.png'
...
const Portfolio=()=>{
    ...
    return(
        <>
        <div id="list-item5" className="portfolio section">
            ...
            <p className="design" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">Innovation Designs</p>
            <p className="inspire" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">Real  <span>Results</span></p><br /><br />
            <div className="row" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">
                <div className="mywork">
                    <div className="picture">
                        <img src={Portfolio_1} alt="my work"/>
                    </div><br />
                    <p className="bigger">Reelup - E commercer Video Platform</p>
                </div>
            </div><br />
            <div className="row-m" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">
                <div className="mywork">
                    <div className="picture">
                        <img src={Portfolio_4} alt="my work" />
                    </div><br />
                    <p>Academy - Sales Career</p>
                </div>
                <div className="mywork">
                    <div className="picture">
                        <img src={Portfolio_3} alt="my work" />
                    </div><br />
                    <p>Leadlogic- Dashboard Design</p>
                </div>
            </div><br />
            <div className="row" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">
                <div className="mywork">
                    <div className="picture">
                        <img src={Portfolio_2} alt="my work" />
                    </div><br />
                    <p className='bigger'>Reelup - E commercer Video Platform</p>
                </div>
            </div>
