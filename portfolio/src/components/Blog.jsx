...
import blog1 from '../assets/photos/blog-img1.png'
import blog2 from '../assets/photos/blog-img2.png'
import blog3 from '../assets/photos/blog-img3.png'
import blog4 from '../assets/photos/blog-img4.png'
import blog5 from '../assets/photos/blog-img5.png'
...
const Blog=()=>{
    ...
    return(
        <>
        <div id="list-item7" className="blog section">
            ...
            <p className="design" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">Our Latest Blog Idea</p>
            <p className="inspire" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">UI/UX <span>Trends</span></p><br /><br />
            <div className="row blogs">
                <div className="blog">
                    <img src={blog1} alt="blog" /><br />
                    <div className="top">
                        <p>UI/UX</p>
                        <p><span><FaRegClock/></span> <span>3 min read</span></p>
                    </div><br />
                    <div className="middle">
                        <p>Crafting Seamless Experiences: My UI/UX Design Philosophy</p>
                    </div><br />
                    <div className="bottom">
                        <div className="left">
                            <div className="pic">
                                <img src={blog5} alt="alex carry" />
                            </div>
                            <p>Alex Carry</p>
                        </div>
                        <div className="right">
                            <p><span><MdDateRange /></span> <span>Oct 26, 2024</span></p>
                        </div>
                    </div>
                </div>
                <div className="blog">
                    <img src={blog2} alt="blog" /><br />
                    <div className="top">
                        <p>UI/UX</p>
                        <p><span><FaRegClock/></span> <span>3 min read</span></p>
                    </div><br />
