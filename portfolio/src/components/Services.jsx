...
const Services=()=>{
    ...
    return(
        <>
        <div className="services section" id="list-item3">
            ...
            <p className="design" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">Elevating Brands</p>
            <p className="inspire" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">Intuitive  <span>Design</span></p><br /><br />
            <div className="element service" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">
            ...
            <div className="element service" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">
                <h4>User Research & Prototyping</h4><br />
